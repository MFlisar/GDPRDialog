...
```java
dependencies {
     implementation 'com.github.ahmmedrejowan:GDPRDialog:LATEST-VERSION'
}
```

LATEST-VERSION: [![Release](https://jitpack.io/v/ahmmedrejowan/GDPRDialog.svg)](https://jitpack.io/#ahmmedrejowan/GDPRDialog)
